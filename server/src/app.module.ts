...
@Module({
  imports: [RecipesModule, HttpModule, TypeOrmModule.forRoot({
    type: 'postgres',
    host: 'localhost',
    port: 5432,
    username: 'postgres',
    ...
    entities: [Recipes,Ingredients,RecipeIngredients,Restrictions,Clients,Diet,Users,ClientsRestrictions,RecipeRestrictions,RecipesDiets],
    synchronize: false,
  })],
  controllers: [AppController],
  providers: [AppService, SpoonapiService, TranslateService],
})
